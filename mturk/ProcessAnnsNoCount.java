/** Process Annotations, no count - TWITTER VERSION
...
public class ProcessAnnsNoCount{

public static void main(String[] args){

	if(args.length < 1){
		System.out.println("Usage: java ProcessAnnsNoCount [annotation-file]");
		System.exit(1);
	}
	...
	try{
		...
		FileWriter out = new FileWriter(filename + ".nocount");
		...
		while(infile.hasNextLine()){
			...
			out.write(ann.substring(0, ann.length()-1) + "\t" + newlangs + "\t" + tweetid + "\t" + text + "\n");
